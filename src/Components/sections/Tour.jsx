const Tour = () => {
  return (
    <>
      ...
      <section id="tour">
        <div className="relative flex items-center justify-center bg-[url('/images/nature.jpg')] bg-center bg-no-repeat bg-cover h-[300px]">
          <div className="flex flex-col items-center justify-center bg-black/40 w-full h-full px-4 lg:px-0">
            ...
            <a href="/tour/main" target="_blank">
              <div className="text-xs lg:text-base text-primary font-semibold bg-white px-4 lg:px-6 py-1.5 lg:py-1.5 rounded-md mt-6">
                Mulai Jelajahi
              </div>
            </a>
          </div>
